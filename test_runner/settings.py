...
DATA_API_BACKENDS_CONFIG = {"rapidpro": {"name": "RapidPro", "slug": "rapidpro", "class_type": None}}
...
BACKENDS_ORG_CONFIG_FIELDS = [
    ...
    dict(
        ...
        field=dict(help_text=_("The label of the Contact Field that contains " "the occupation of reporters")),
        superuser_only=True,
        read_only=True,
    ),
    dict(
    ...
    dict(
        name="state_label",
        field=dict(help_text=_("The label of the Contact Field that contains " "the State of reporters")),
        superuser_only=True,
        read_only=True,
    ),
    dict(
        name="district_label",
        field=dict(help_text=_("The label of the Contact Field that contains " "the District of reporters")),
        superuser_only=True,
        read_only=True,
    ),
    dict(
...
ORG_CONFIG_FIELDS = [
    dict(
        name="shortcode",
        field=dict(help_text=_("The shortcode that users will use to contact U-report locally"), required=True),
    ),
    dict(
        name="join_text",
        field=dict(help_text=_("The short text used to direct visitors to join U-report"), required=False),
    ),
    dict(
        name="join_fg_color",
    ...
    dict(
        ...
        field=dict(help_text=_("The Google Analytics Tracking ID for this organization"), required=False),
    ),
    dict(
        name="youtube_channel_url",
        field=dict(help_text=_("The URL to the Youtube channel for this organization"), required=False),
    ),
    dict(
        name="facebook_page_url",
        field=dict(help_text=_("The URL to the Facebook page for this organization"), required=False),
    ),
    dict(name="twitter_handle", field=dict(help_text=_("The Twitter handle for this organization"), required=False)),
    dict(
        name="twitter_user_widget",
        field=dict(help_text=_("The Twitter widget used for following new users"), required=False),
    ),
    dict(
        name="twitter_search_widget", field=dict(help_text=_("The Twitter widget used for searching"), required=False)
    ),
