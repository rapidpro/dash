    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background_type', models.CharField(default='P', max_length=1, verbose_name='Background type', choices=[('B', 'Banner'), ('P', 'Pattern')])),
                ...
                ('org', models.ForeignKey(verbose_name='Org', to='orgs.Org', help_text='The organization in which the image will be used')),
            ],
            options={
                'abstract': False,
            },
