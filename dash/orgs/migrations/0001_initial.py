    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "language",
                    models.CharField(
                        choices=[("en-us", "English"), ("rw", "Kinyarwanda"), ("fr", "French")],
                        max_length=64,
                        blank=True,
                ...
                (
                    ...
                    models.SlugField(
                        ...
                        max_length=255,
                        help_text="The subdomain for this UReport instance",
                        unique=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name="Org", to="orgs.Org", on_delete=models.PROTECT, help_text="The organization to which the account is invited to view"
            ),
